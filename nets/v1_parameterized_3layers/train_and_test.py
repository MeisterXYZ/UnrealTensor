...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(int(sys.argv[3]), activation="relu", input_shape=(200,)),  # input shape required
    tf.keras.layers.Dense(int(sys.argv[4]), activation="relu"),
    tf.keras.layers.Dense(int(sys.argv[5]), activation="relu"),
